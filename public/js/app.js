...
$(document).ready(function () {
  ...
  btnEnter.addEventListener('click', function () {
    var enterEmail = document.getElementById('exampleInputEmail').value;
    var enterPassword = document.getElementById('exampleInputPassword').value;
  ...
  function elementSeen(user) {
    var userLog = user;
    var contentSee = document.getElementById('content');
